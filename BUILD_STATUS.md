...
### 2026-03-08 — Fix CMakeLists.txt not found (Microsoft C++ Code Analysis CI failure)
...
- Added minimal `CMakeLists.txt` to repository root so CMake configure step succeeds
